...
export function Hero() {
  ...
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      {/* ── DESKTOP (original, sin tocar) ── */}
      <div className="hidden lg:flex items-center min-h-[88vh] pt-[80px]">
        <div className="max-w-7xl mx-auto px-5 w-full grid grid-cols-2 gap-0 min-h-[88vh]">

          {/* Left: text */}
          <div className="flex flex-col justify-center py-16 pr-16">
          ...
          {/* Right: mood board grid (original) */}
          <div className="grid grid-cols-2 grid-rows-3 gap-2 pt-[110px] pb-8">
      ...
      {/* ── MOBILE ── */}
      <div className="lg:hidden pt-[64px]">
